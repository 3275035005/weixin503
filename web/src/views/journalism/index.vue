  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="资讯标题">
        <el-input v-model="dataVo.title" placeholder="请输入资讯标题"/>
      </el-form-item>
      <el-form-item label="资讯分类名称">
        <el-select
          v-model="dataVo.classifiedId"
          placeholder="请选择资讯分类名称">
          <el-option
    ...
    >
      ...
      <el-table-column align="center" label="资讯封面">
        <template slot-scope="scope">
          <img
      ...
      <el-table-column prop="classifiedName" label="资讯分类名称"/>
    ...
    >
      ...
      <el-form :model="formData" label-position="left" label-width="120px">
        <el-form-item label="资讯名称">
          <el-input v-model="formData.title" placeholder="请填写资讯名称"/>
        </el-form-item>
        <el-form-item label="资讯分类名称">
          <el-select
...
<script>
import { deleteById, insert, update, pageQuery } from '@/api/journalism'
import Tinymce from '@/components/Tinymce'
import { getClassifiedAll } from '@/api/journalismClassified';
